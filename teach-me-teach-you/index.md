...
flowchart LR
    ...
    subgraph model["What I assumed, with zero context"]
        A --> A1["<div style='max-width:280px'>This is where the programming happens. As far as what the syntax is, what this line of code means, or how to actually code new lines - no idea </div>"]
        B --> B1["Several tabs, none of which meant much to me:<ul style='text-align:left;max-width:280px;white-space:normal'><li><b>Welcome</b>: What I'm greeted with when opening the app, with information on Strudel</li><li><b>Patterns</b>: Maybe a collection of pre-made musical patterns (drums, riffs, etc.)?</li><li><b>Sounds</b>: Maybe a sound/instrument library, for changing voices?</li><li><b>Reference</b>: Documentation or help resources</li><li><b>Export</b>: exporting the song as an audio file, or maybe exporting as a shareable link?</li><li><b>Console</b>: Some kind of dev-console-style output log, but what would we need a console for with a program like this?</li><li><b>Settings</b>: Standard preferences and settings menu, for theming, IDE setup, etc.</li></ul>"]
        C --> C1["There's several links on the right side:<ul style='text-align:left;max-width:280px;white-space:normal'><li><b>▶️Play</b>: The play/pause button</li><li><b>Update</b>: Could mean lots of things (update the program? update the window?)</li><li><b>Share</b>: I assume gives an exportable link (but how is this different than export in the side panel?)</li><li><b>Learn</b>: A link to a tutorial website</li></ul>"]
    end
```
