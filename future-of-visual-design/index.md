...
![Mood board](img/evil-eye-moodboard.png)
...
<div class="type-specimen">
  <p class="display">SLEEP WELL CITIZEN</p>
  <p class="glyphs">
    ABCDEFGHIJKLMNOPQRSTUVWXYZ<br>
    abcdefghijklmnopqrstuvwxyz<br>
    0123456789 &nbsp; &mdash; / . , : ( ) # &amp;
  </p>
  <p class="meta">Safety is not something you do. It is something done for you, continuously, at no charge. Every door accounted for. Every hour on file. Sleep well, knowing someone is awake on your behalf.</p>
</div>
...
<div class="palette">
  <div class="swatch">
    <div class="chip" style="background:#000000;"></div>
    <div class="info">
  ...
  <div class="swatch">
    <div class="chip" style="background:#1F1F1F;"></div>
    <div class="info">
      <span class="name">Grey</span>
      <span class="hex">#1F1F1F</span>
    </div>
  </div>
  <div class="swatch">
    <div class="chip" style="background:#004a09;"></div>
    <div class="info">
      <span class="name">Green</span>
      <span class="hex">#004a09</span>
    </div>
  </div>
</div>
...
<div style="display: flex; gap: 1rem; align-items: flex-start; margin: 1rem 0;">
  <figure style="flex: 1; margin: 0;">
    <img src="img/evil-eye-v2.png" alt="Iris-lens mark study full color" style="width: 100%; height: auto;">
    <figcaption style="text-align: center; font-size: 0.85rem; opacity: 0.7; margin-top: 0.4rem;">Full color</figcaption>
  </figure>
  <figure style="flex: 1; margin: 0;">
    <img src="img/evil-eye-v2-monocolor.png" alt="Iris-lens mark study one color" style="width: 100%; height: auto;">
...
- The _radiating iris_ is meant to look like a **camera aperture**, or possibly a **radar sweep**.
- The _light mark_ helps to sell it as a human eye; without it, the eye looks too digital and camera-esque. I have to humanize my dystopian propaganda tech, after all.
  - It also does double-duty as the "blip" in the radar interpretation.
- The _eyelashes_ are meant to somewhat resemble bird feathers or wings, giving a subtle nod to the current name of the company.
- The eye _stares straight_ at the user, conveying the "always watching" theme. This is common to eye symbols generally.
